        ...
        {created ? (
          <div className="space-y-3">
            ...
            <div className="rounded-md border border-border px-3 py-2">
              <p className="text-meta font-medium">Use it like this</p>
              <pre className="mt-1 overflow-x-auto text-meta leading-relaxed text-muted-foreground">{`curl -X POST ${typeof window === 'undefined' ? '' : window.location.origin}/api/public/v1/leads \\
