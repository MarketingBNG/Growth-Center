  ...
  return (
    <main className="grid min-h-screen place-items-center bg-background px-6">
      <div className="flex max-w-[460px] flex-col items-center gap-3 text-center">
        ...
        <h1 className="text-display font-extrabold tracking-[-0.03em]">Something went wrong</h1>
        ...
        {error.digest ? (
          <p className="font-mono text-meta text-muted-foreground">ref {error.digest}</p>
        ) : null}
