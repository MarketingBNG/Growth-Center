 ...
 */
// `Range` and `rangeFor` live in lib/shared/range.ts now — lib/money/attribution.ts needs the same
...
// The Kpi shape and its delta live in lib/shared/kpi.ts so client components can use them
