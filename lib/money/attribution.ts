...
import { currencySettings, thresholds } from '../platform/settings.ts';
import { THRESHOLDS, parseThresholdValue } from '../shared/thresholds.ts';
import { num, rate } from '../shared/calc.ts';
import { TAGS, cached } from '../platform/cache.ts';
import { rangeFor } from '../shared/range.ts';
