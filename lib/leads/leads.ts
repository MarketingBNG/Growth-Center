...
import { z } from 'zod';
import { recordId } from '../platform/id.ts';
import { db } from '../platform/prisma.ts';
import { dispatch } from '../platform/events.ts';
import { companyDomainFromEmail, normalizeCompanyName, normalizeEmail } from '../crm/dedupe.ts';
import type { ListQuery } from '../platform/api.ts';
import { LEAD_STATUSES, SOURCE_TYPES } from '../shared/enums.ts';
import {
  channelSlugFor,
  leadCampaign,
  leadSourceGroup,
