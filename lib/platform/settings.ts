...
import { fetchRates } from '../money/fx.ts';
import { OWNERS_KEY, OWNER_DOMAINS, type OwnerBindings, type OwnerDomain } from '../insights/insight-owners.ts';
import { canonicalEmail } from '../access/roles.ts';
...
import { GLOSSARY_SLUGS, ownerKey, parseOwner } from '../shared/glossary.ts';
